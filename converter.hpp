...
class Converter {
    ...
    uint64_t m_num_edges_total = 0; // total number of edges
    ...
    void init_read_input_graph(void* ptr_edges_total, void* ptr_frequencies, const std::string& path_input_graph, uint64_t input_num_vertices_final, uint64_t input_num_edges_final);
    void init_permute_edges_final(std::unique_ptr<WeightedEdge[]>& ptr_edges_total);
    void init_edges_final_no_permute(std::unique_ptr<WeightedEdge[]>& ptr_edges_total);
